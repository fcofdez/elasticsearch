...
public class ES94BloomFilterDocValuesFormat extends DocValuesFormat {
    ...
    // MAX_BLOOM_FILTER_SIZE dominates; higher bits/doc would waste memory without proportional
    // FP-rate benefit.
    //
    ...
    // that uses less memory. Power-of-two rounding always inflates the allocated filter (actual
