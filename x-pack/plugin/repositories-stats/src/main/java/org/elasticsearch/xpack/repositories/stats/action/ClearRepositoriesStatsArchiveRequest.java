...
public class ClearRepositoriesStatsArchiveRequest extends BaseNodesRequest<ClearRepositoriesStatsArchiveRequest> {
    ...
    public ClearRepositoriesStatsArchiveRequest(DiscoveryNode... concreteNodes) {
        super(concreteNodes);
    }
}
