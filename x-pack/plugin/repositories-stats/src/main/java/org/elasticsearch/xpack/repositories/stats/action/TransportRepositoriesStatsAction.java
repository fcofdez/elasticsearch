...
public class TransportRepositoriesStatsAction extends TransportNodesAction<RepositoriesStatsRequest,
    ...
    @Inject
    public TransportRepositoriesStatsAction(ThreadPool threadPool,
    ...
    @Override
    protected RepositoriesStatsResponse newResponse(RepositoriesStatsRequest request,
