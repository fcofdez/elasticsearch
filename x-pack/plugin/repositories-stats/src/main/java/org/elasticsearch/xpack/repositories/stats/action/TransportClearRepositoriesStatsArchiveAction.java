...
public class TransportClearRepositoriesStatsArchiveAction extends TransportNodesAction<ClearRepositoriesStatsArchiveRequest,
    ...
    @Inject
    public TransportClearRepositoriesStatsArchiveAction(ThreadPool threadPool,
    ...
    @Override
    protected ClearRepositoriesStatsArchiveResponse newResponse(ClearRepositoriesStatsArchiveRequest request,
